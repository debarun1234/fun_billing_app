  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div
          className="w-full md:w-96 bg-white shadow-2xl print-receipt relative overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none select-none flex flex-col items-center justify-center opacity-[0.05] overflow-hidden z-0">
            {Array.from({ length: 15 }).map((_, i) => (
              <div
                key={i}
                className="transform -rotate-45 text-red-600 font-black whitespace-nowrap my-6 tracking-widest"
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <div style={{ fontSize: '7px', marginTop: '4px', color: '#9e9d9dff', textAlign: 'center' }}>
